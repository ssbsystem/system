...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Dec 23. 21:12
...
INSERT INTO `projects` (`ProjectId`, `Name`, `StartDate`, `FinishDate`, `Deadline`, `ParentFK`, `IsChild`) VALUES
(1, 'SSBS elkészítése1', '2019-12-19 00:00:00', '2020-01-03 00:00:00', '2020-01-02 00:00:00', NULL, 1),
(2, 'SSBS elkészítése2', '2019-12-21 00:00:00', '2019-12-25 00:00:00', '2019-12-26 00:00:00', 1, 1),
(3, 'SSBS elkészítése3', '2019-12-22 00:00:00', '2019-12-25 00:00:00', '2019-12-24 00:00:00', 2, 0),
(4, 'SSBS elkészítése4', '2019-12-25 00:00:00', '2020-01-01 00:00:00', '2019-12-31 00:00:00', 1, 0),
(5, 'SSBS elkészítése5', '2019-09-05 00:00:00', '2019-11-05 00:00:00', '2019-10-26 00:00:00', NULL, 0);
...
CREATE TABLE `virtual_objects` (
  ...
  `SelectString` text DEFAULT NULL,
  `WhereString` varchar(30) DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `task_steps`
  MODIFY `TaskStepId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `virtual_objects`
  MODIFY `VirtualObjectId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
