...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Dec 07. 12:27
...
INSERT INTO `cardc_structures` (`StuctureId`, `Number`, `ColumnName`, `IsMainId`, `Tables`, `BackendF`, `Place`, `EmployeeFK`) VALUES
(1, 1, 'TaskId', 1, NULL, NULL, 'taskmd', 1),
(2, 2, 'Name', 0, NULL, NULL, 'taskmd', 1),
(4, 3, 'TaskType.Name', 0, 'task_types', NULL, 'taskmd', 1),
(7, 1, 'LogoSrc', 0, NULL, NULL, 'prtnrmd', 1),
(8, 2, 'Name', 0, NULL, NULL, 'prtnrmd', 1),
(9, 3, 'Phone', 0, NULL, NULL, 'prtnrmd', 1),
(10, 4, 'Address', 0, NULL, NULL, 'prtnrmd', 1),
(11, 5, 'PartnerId', 1, NULL, NULL, 'prtnrmd', 1),
(13, NULL, 'PartnerType.Name', 0, 'partner_types', NULL, 'prtnrmd', 1),
(14, 1, 'PartnerContactId', 1, NULL, NULL, 'prtnrdcnt', 1),
(15, 2, 'Name', 0, NULL, NULL, 'prtnrdcnt', 1),
(16, 3, 'Email', 0, NULL, NULL, 'prtnrdcnt', 1),
(17, 4, 'Phone', 0, NULL, NULL, 'prtnrdcnt', 1),
(18, 5, 'Address', 0, NULL, NULL, 'prtnrdcnt', 1),
(19, 1, 'Icon', 0, NULL, NULL, 'tlsmd', 1),
(20, 2, 'Name', 0, NULL, NULL, 'tlsmd', 1),
(21, 3, 'Place', 0, NULL, NULL, 'tlsmd', 1),
(22, 4, 'ToolAvailability.Name', 0, 'tool_availabilities', NULL, 'tlsmd', 1),
(23, 5, 'ToolId', 0, NULL, NULL, 'tlsmd', 1),
(24, NULL, 'CreatedDate', 0, NULL, NULL, 'taskmd', 1),
(25, NULL, 'Deadline', 0, NULL, NULL, 'taskmd', 1),
(26, NULL, 'Description', 0, NULL, NULL, 'taskmd', 1),
(28, 1, 'Number', 0, NULL, NULL, 'taskwy', 1),
(29, 2, 'TaskStep.Name', 0, 'task_steps', NULL, 'taskwy', 1),
(30, 3, 'Number', 0, NULL, NULL, 'taskwy', 1),
(31, 4, 'TaskStepFK', 0, NULL, NULL, 'taskwy', 1),
(32, 5, 'Number', 0, NULL, NULL, 'taskwy', 1),
(33, 6, 'TaskStepFK', 0, NULL, NULL, 'taskwy', 1),
(35, NULL, 'Active', 0, NULL, NULL, 'taskwy', 1),
(37, 1, 'TaskStepFK', 0, NULL, NULL, 'ntaskwy', 1),
(38, 3, 'TaskStep.Name', 0, 'task_steps', NULL, 'ntaskwy', 1),
(39, 2, 'Number', 0, NULL, NULL, 'ntaskwy', 1),
(41, NULL, 'TaskFK', 0, NULL, NULL, 'taskwy', 1),
(42, NULL, 'Email', 0, NULL, NULL, 'prtnrmd', 1),
(43, 1, 'EmployeeId', 1, NULL, NULL, 'emplmd', 1),
(44, 2, 'EmployeePosition.Name', 0, 'employee_positions', NULL, 'emplmd', 1),
(45, 3, 'TotalCost', 0, NULL, NULL, 'emplmd', 1),
(46, 4, 'FirstName', 0, NULL, NULL, 'emplmd', 1),
(47, 5, 'LastName', 0, NULL, NULL, 'emplmd', 1),
(48, NULL, 'GrossSalary', 0, NULL, NULL, 'emplmd', 1),
(49, NULL, 'NetSalary', 0, NULL, NULL, 'emplmd', 1),
(50, NULL, 'OtherAllowances', 0, NULL, NULL, 'emplmd', 1),
(51, 6, 'Rate', 0, NULL, NULL, 'emplmd', 1),
(52, 1, 'OrderId', 1, NULL, NULL, 'ordrmd', 1),
(53, 3, 'AliasId', 0, NULL, NULL, 'ordrmd', 1),
(54, 2, 'Name', 0, NULL, NULL, 'ordrmd', 1),
(55, NULL, 'Customer.FirstName', 0, 'customers', NULL, 'ordrmd', 1),
(56, NULL, 'Partner.Name', 0, 'partners', NULL, 'ordrmd', 1),
(57, NULL, 'AvailableTools', 0, NULL, NULL, 'tlsmd', 1),
(58, NULL, 'Customer.LastName', 0, 'customers', NULL, 'ordrmd', 1),
(59, 4, 'OrderDate', 0, NULL, NULL, 'ordrmd', 1),
(60, NULL, 'OrderId.OrderProducts', 0, NULL, 'vo/1//OrderId', 'ordrmd', 1),
(61, NULL, 'OrderId.OrderServices', 0, NULL, 'vo/2//OrderId', 'ordrmd', 1),
(62, NULL, 'LastMaintenance', 0, NULL, NULL, 'tlsmd', 1),
(63, NULL, 'MaintenancePeriod', 0, NULL, NULL, 'tlsmd', 1),
(64, NULL, 'Description', 0, NULL, NULL, 'tlsmd', 1),
(65, NULL, 'ToolType.Name', 0, 'tool_types', NULL, 'tlsmd', 1),
(66, NULL, 'ToolId.ToolRemarks', 0, NULL, 'vo/3//ToolId', 'tlsmd', 1),
(67, NULL, 'PartnerId.PartnerContacts', 0, NULL, 'vo/4//PartnerId', 'prtnrmd', 1);
