...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Nov 05. 16:29
...
CREATE TABLE `virtual_objects` (
  ...
  `ObjNameAlias` varchar(30) NOT NULL,
...
--
ALTER TABLE `cardc_structures`
  MODIFY `StuctureId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `virtual_objects`
  MODIFY `VirtualObjectId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
