...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Máj 11. 14:53
...
-- Eljárások
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Test2` (IN `Szam` INT(11) UNSIGNED)  READS SQL DATA
...
(1, 'Ádám', 'Werner', 1, 100000, 80000, 30000, 0, 130000, 4.9, '$2y$10$zocdccAOTxHuQPVPnaiyv.w8Q/lAbXVE1pPwx93d13j7J.mbS5N/e', 'werner.adam@ssbs.com'),
...
(8, 'newtsk', 5, NULL, 'Feladat lépési', 'ST', NULL, 'TaskStepId,Name', 'task_steps', 'TaskStep', 'task_steps.Name', 1, 1, NULL),
...
(1, 'SSBS elkészítése1', '2020-03-01 00:00:00', '2020-04-06 00:00:00', '2020-04-06 00:00:00', NULL),
(2, 'SSBS elkészítése2', '2020-03-01 00:00:00', '2020-03-20 00:00:00', '2020-03-20 00:00:00', 1),
(3, 'SSBS elkészítése3', '2020-03-14 00:00:00', '2020-03-19 00:00:00', '2020-03-19 00:00:00', 2),
(4, 'SSBS elkészítése4', '2020-03-18 00:00:00', '0000-00-00 00:00:00', '2020-03-23 00:00:00', 5),
(5, 'SSBS elkészítése5', '2020-03-13 00:00:00', '0000-00-00 00:00:00', '2020-03-22 00:00:00', NULL);
...
(1, 'Termék', 'simple', 'SELECT order_products.Quantity AS \"4\", products.ProductId AS \"1\", products.AliasId AS \"2\", products.Name AS \"3\", products.SalePrice AS \"5\" FROM `order_products` INNER JOIN products ON ProductFK=ProductId WHERE OrderFK=<0>'),
(2, 'Szolgáltatás', 'simple', 'SELECT services.ServiceId AS \"1\", services.Name AS \"2\", services.Price AS \"3\" FROM `order_services` INNER JOIN services ON ServiceFK=ServiceId WHERE OrderFK=<0>'),
(3, 'Megjegyzések', 'remark', 'SELECT `ToolRemarkId` AS \"1\", CONCAT(employees.LastName, \" \", employees.FirstName) AS \"2\", `RemarkText` AS \"3\", `CreatedDate` AS \"4\" FROM `tool_remarks` inner join employees on EmployeeId=EmployeeFK WHERE ToolFK=<0>'),
(4, 'Kapcsolatok', 'contacts', 'SELECT `PartnerContactId` AS \"1\", `Name` AS \"2\", `Email` AS \"3\", `Phone` AS \"4\", `Address` AS \"5\" FROM `partner_contacts` WHERE PartnerFK=<0>'),
...
--
ALTER TABLE `partner_types`
  MODIFY `PartnerTypeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `task_steps`
  MODIFY `TaskStepId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `form_structures`
  ADD CONSTRAINT `form_structures_ibfk_1` FOREIGN KEY (`Type`) REFERENCES `c_input_types` (`Id`);
