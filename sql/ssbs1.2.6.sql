...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Nov 03. 17:04
...
(22, 4, 'ToolAvailability.Name', 'tool_availabilities', 'tlsmd', 1),
...
(52, 1, 'OrderId', NULL, 'ordrmd', 1),
(53, 2, 'AliasId', NULL, 'ordrmd', 1),
(54, 3, 'Name', NULL, 'ordrmd', 1),
(55, 4, 'Customer.Name', 'customers', 'ordrmd', 1),
(56, 4, 'Partner.Name', 'partners', 'ordrmd', 1),
(57, NULL, 'AvailableTools', NULL, 'tlsmd', 1);
...
INSERT INTO `order_services` (`OrderService`, `OrderFK`, `ServiceFK`) VALUES
(1, 2, 1),
(2, 2, 2);
...
INSERT INTO `tools` (`ToolId`, `Name`, `Type`, `Icon`, `ToolAvailabilityFK`, `AvailableTools`, `Place`, `Description`, `LastMaintenance`, `MaintenancePeriod`) VALUES
(1, 'Samsung laptop', '', 'fa fa-plus', 1, 2, 'Gyár, 3-as raktár', 'Semmi extra.', '2019-02-01 00:00:00', 120);
...
--
ALTER TABLE `cardc_structures`
  MODIFY `StuctureId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `dtls_structures`
  MODIFY `StuctureId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `order_services`
  MODIFY `OrderService` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `virtual_objects`
  MODIFY `VirtualObjectId` int(11) NOT NULL AUTO_INCREMENT;
