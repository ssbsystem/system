...
(8, 'Lépés választása', 'employees', 'EmployeeId', 'FirstName'),
...
(1, 1, 'newtsk', 1, 5, NULL, 'W', NULL, 'tasks.Name', 1),
(2, 1, 'newtsk', 2, 3, NULL, 'SN', NULL, 'tasks.TaskTypeFK', 1),
(3, 1, 'newtsk', 3, 2, NULL, 'DT', NULL, 'tasks.Deadline', 0),
(4, 1, 'newtsk', 4, 1, NULL, 'S', NULL, 'tasks.ProjectFK', 0),
(15, 2, 'stepbx', 1, 6, NULL, 'WP', NULL, 'task_ways.TaskStepFK', 1),
...
INSERT INTO `f_module_plugins` (`FModulePluginId`, `FUserModuleFK`, `CPluginFK`, `Place`, `Number`, `DefaultScreen`) VALUES
(1, 4, 2, 100, 4, 1),
(2, 4, 3, 2, 1, 1),
(3, 4, 4, 4, 2, 1),
(4, 4, 5, 5, 3, 1);
...
INSERT INTO `f_plugin_plugins` (`FPluginPluginId`, `FModulePluginFK`, `FPluginPluginFK`, `CPluginFK`, `Place`, `Number`, `DefaultScreen`) VALUES
(1, 1, NULL, 1, 1, 1, 1),
(2, 4, NULL, 6, 1, 1, 1);
...
--
ALTER TABLE `f_columns`
  MODIFY `FColumnId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT a táblához `f_display`
--
ALTER TABLE `f_display`
  MODIFY `FDisplayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT a táblához `f_form_inputs`
--
ALTER TABLE `f_form_inputs`
  MODIFY `FFormInputId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `f_plugin_display`
  MODIFY `FPluginDisplayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT a táblához `f_plugin_form_inputs`
--
ALTER TABLE `f_plugin_form_inputs`
  MODIFY `FPluginFormInputId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT a táblához `f_plugin_plugins`
--
ALTER TABLE `f_plugin_plugins`
  MODIFY `FPluginPluginId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
