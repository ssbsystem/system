...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Sze 29. 22:30
...
(1, 'taskfltr', 1, 'Feladat típus', 'S', NULL, 'TaskType.Name', 'task_types', 1, 0),
(2, 'taskfltr', 2, 'Feladat név', 'W', NULL, 'Name', 'tasks', 1, 0),
(3, 'prtnrfltr', 1, 'Partner név', 'W', NULL, 'Name', 'partners', 1, 0),
(4, 'prtnrfltr', 2, 'Cimke', 'S', NULL, 'PartnerTags.Name', 'partner_tags', 1, 0),
...
INSERT INTO `partner_tags` (`PartnerTagId`, `Name`, `PartnerFK`) VALUES
(1, 'Fontos', 1),
(2, 'Alkatrészek', 1);
...
(1, 'SSBS elkészítése1', '2019-09-05 00:00:00', '2019-09-21 00:00:00', NULL, 1, '2019-09-30 00:00:00'),
(2, 'SSBS elkészítése2', '2019-09-05 00:00:00', '2019-09-16 00:00:00', 1, 1, '2019-09-30 00:00:00'),
...
(5, 'SSBS elkészítése5', '2019-09-05 00:00:00', '2019-09-21 00:00:00', NULL, 0, '2019-09-30 00:00:00');
...
INSERT INTO `tasks` (`TaskId`, `Name`, `TaskTypeFK`, `TaskCategoryFK`, `CreatedDate`, `DeadLine`, `Description`, `OrderFK`, `ProjectFK`) VALUES
(1, 'Feladatkezelés megtervezése', 1, 1, '2019-08-29 01:36:25', '2019-09-26 00:00:00', 'Ez al első', NULL, 1),
(2, 'PHP megtervezése 2', 1, NULL, '2019-08-29 01:40:22', NULL, NULL, NULL, NULL),
(9, '100. feladat', 1, NULL, '2019-09-08 22:19:20', NULL, NULL, NULL, NULL),
(10, '100. feladat4', 2, NULL, '2019-09-08 22:27:33', NULL, NULL, NULL, NULL),
(11, '100. feladat3', 2, NULL, '2019-09-08 22:35:06', NULL, NULL, NULL, NULL),
(13, 'Task', 1, NULL, '2019-09-26 15:48:05', '2019-01-01 00:00:00', NULL, NULL, 4),
(14, 'Task2', 1, NULL, '2019-09-26 15:48:27', '0000-00-00 00:00:00', NULL, NULL, 4),
(15, 'Task5', 2, NULL, '2019-09-26 15:50:02', '0000-00-00 00:00:00', NULL, NULL, 2),
(16, 'Test10', 1, NULL, '2019-09-26 15:58:29', NULL, NULL, NULL, 1),
(17, 'Test12', 1, NULL, '2019-09-26 15:59:34', '0000-00-00 00:00:00', NULL, NULL, 1),
(18, '14', 1, NULL, '2019-09-26 16:00:20', NULL, NULL, NULL, 1),
(19, 'Task15', 2, NULL, '2019-09-26 16:01:42', NULL, NULL, NULL, 3),
(21, 'Első sikeres', 1, NULL, '2019-09-27 23:55:25', '2019-01-01 00:00:00', NULL, NULL, 1),
(22, 'Második sikeres', 2, NULL, '2019-09-27 23:58:43', NULL, NULL, NULL, 1),
(23, 'Harmadik', 2, NULL, '2019-09-28 00:02:33', NULL, NULL, NULL, 1),
(24, 'Negyedik', 1, NULL, '2019-09-28 00:03:31', NULL, NULL, NULL, 1),
(25, 'Az én kedvesem', 1, NULL, '2019-09-28 18:56:05', '2019-01-01 00:00:00', NULL, NULL, 2);
...
INSERT INTO `task_ways` (`TaskWayId`, `Number`, `TaskFK`, `TaskStepFK`, `EmployeeFK`, `Active`) VALUES
(1, 1, 1, 1, 1, 0),
(2, 2, 1, 2, 3, 0),
(3, 3, 1, 3, 1, 1),
(4, 4, 1, 4, 1, 0),
...
ALTER TABLE `partners`
  ...
  ADD KEY `PartnerTypeFK` (`PartnerTypeFK`);
...
--
ALTER TABLE `cardc_structures`
  MODIFY `StuctureId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `task_steps`
  MODIFY `TaskStepId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `task_ways`
  MODIFY `TaskWayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `partners`
  ADD CONSTRAINT `partners_ibfk_1` FOREIGN KEY (`PartnerTypeFK`) REFERENCES `partner_types` (`PartnerTypeId`);
...
--
ALTER TABLE `task_ways`
  ADD CONSTRAINT `task_ways_ibfk_1` FOREIGN KEY (`TaskStepFK`) REFERENCES `task_steps` (`TaskStepId`);
COMMIT;
