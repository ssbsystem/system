...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Nov 16. 17:04
...
INSERT INTO `sorts` (`SortId`, `Place`, `Number`, `Name`, `DefaultValue`, `ColumnName`, `TableName`, `EmployeeFK`) VALUES
(1, 'tskfltr', 2, 'Feladat típus', 0, 'TaskType.Name', 'task_types', 1),
(2, 'tskfltr', 1, 'Feladat név', 1, 'Name', 'tasks', 1),
(3, 'prtnrfltr', 1, 'Partner név', 0, 'Name', '', 1),
(4, 'prtnrfltr', 2, 'Cimke', 0, 'TagForPartner.PartnerTag.Name', '', 1),
(5, 'tlsfltr', 2, 'Elérhetőség', 0, 'ToolAvailability.Name', '', 1),
(6, 'tlsfltr', 1, 'Eszköz neve', 0, 'Name', '', 1),
(7, 'emlpfltr', 1, 'Keresztnév', 0, 'FirstName', '', 1),
(8, 'emlpfltr', 2, 'Pozíció', 0, 'EmployeePosition.Name', '', 1),
(9, 'ordrfltr', 1, 'Rendelés neve', 0, 'Name', '', 1),
(10, 'ordrfltr', 2, 'Rendelés azonosító', 0, 'AliasId', '', 1);
...
--
ALTER TABLE `task_ways`
  MODIFY `TaskWayId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
